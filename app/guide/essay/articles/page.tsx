          ...
          <div className="mb-12">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#002147]">
                SFC小論文の「正しい書き方」と「時間の使い方」を知る
              </h2>
            </div>
            <p className="text-slate-600 ml-16 text-sm md:text-base leading-relaxed">
              SFCの小論文は普通の作文とは違います。まずは「どう書くべきか」という基本ルールと、時間内に書き切るための「時間配分のコツ」をしっかりと身につけましょう。
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="mb-12">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#002147]">
                膨大な資料から「使える情報」を見つけ出す
              </h2>
            </div>
            <p className="text-slate-600 ml-16 text-sm md:text-base leading-relaxed">
              書き方が分かっても、書くための「材料」がなければ戦えません。次に、SFC特有のたくさんの資料から必要な情報だけを素早く読み取るコツと、よく出るテーマの基礎知識を学びます。
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="mb-12">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#002147]">
                過去問を解きながら「合格レベルの答案」に仕上げていく
              </h2>
            </div>
            <p className="text-slate-600 ml-16 text-sm md:text-base leading-relaxed">
              基本の型と材料の集め方がわかったら、いよいよ過去問演習です。これらを組み合わせて、どうやって合格点の取れる答案を作り上げていくのか、効率的な自学自習の方法をお伝えします。
            </p>
          </div>
